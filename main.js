...
// Enemy Names
var enemyNamePrefix = ["Malakith", "Zorren", "Karak", "Maldred", "Skidrel", "Valcor", "Synoid", "Terendal", "Hydras", "Covela", "Saratose", "Idrak", "Boldran", "Novark", "Potrius", "Quaras", "Tetripak", "Reshdak", "Xorn", "Lojoshako"];

var enemyNameSuffix = ["The Demolisher", "The Inaiahilator", "Storm Bringer", "The Shadow", "Blade Master", "The Soilder", "Soul Eater", "Black Heart", "Death Monger", "Shreader", "Devourer", "The Infested", "The Ripper", "The Deamon", "Of Flame", "Of Death", "Of Smoke", "Of Wrath", "The Snake", "The Soulless"];
...
function updateStats(start) {
    ...
    if (Player.currentWeapon.type == 1) {
        if (Player.currentWeapon.fireDamage > 0 && Player.currentWeapon.iceDamage == 0 && Player.currentWeapon.poisonDamage == 0) {
            $("#sidebar").append("<h3 style='margin-bottom: 0px;'>Weapon Stats:</h3><br><div id='weaponContainer'><img class='weapon fire lvl" + Player.currentWeapon.weaponLevel + "' src='icons/sword.png' width='10px' height='10px'><div id='wStatContainer'>Name: " + Player.currentWeapon.name + "<br>Type: " + Player.currentWeapon.type + "<br>Damage: " + Player.currentWeapon.baseDamage + "<br>Range: " + Player.currentWeapon.range + "<br>Elemental Damage:<br>Attributes: </div></div></div>");
        } else if (Player.currentWeapon.iceDamage > 0 && Player.currentWeapon.fireDamage == 0 && Player.currentWeapon.poisonDamage == 0) {
            $("#sidebar").append("<h3 style='margin-bottom: 0px;'>Weapon Stats:</h3><br><div id='weaponContainer'><img class='weapon ice lvl" + Player.currentWeapon.weaponLevel + "' src='icons/sword.png' width='10px' height='10px'><div id='wStatContainer'>Name: " + Player.currentWeapon.name + "<br>Type: " + Player.currentWeapon.type + "<br>Damage: " + Player.currentWeapon.baseDamage + "<br>Range: " + Player.currentWeapon.range + "<br>Elemental Damage:<br>Attributes: </div></div></div>");
        } else if (Player.currentWeapon.poisonDamage > 0 && Player.currentWeapon.iceDamage == 0 && Player.currentWeapon.fireDamage == 0) {
            $("#sidebar").append("<h3 style='margin-bottom: 0px;'>Weapon Stats:</h3><br><div id='weaponContainer'><img class='weapon poison lvl" + Player.currentWeapon.weaponLevel + "' src='icons/sword.png' width='10px' height='10px'><div id='wStatContainer'>Name: " + Player.currentWeapon.name + "<br>Type: " + Player.currentWeapon.type + "<br>Damage: " + Player.currentWeapon.baseDamage + "<br>Range: " + Player.currentWeapon.range + "<br>Elemental Damage:<br>Attributes: </div></div></div>");
        } else {
            $("#sidebar").append("<h3 style='margin-bottom: 0px;'>Weapon Stats:</h3><br><div id='weaponContainer'><img class='weapon lvl" + Player.currentWeapon.weaponLevel + "' src='icons/sword.png' width='10px' height='10px'><div id='wStatContainer'>Name: " + Player.currentWeapon.name + "<br>Type: " + Player.currentWeapon.type + "<br>Damage: " + Player.currentWeapon.baseDamage + "<br>Range: " + Player.currentWeapon.range + "<br>Elemental Damage:<br>Attributes: </div></div></div>");
        }
    } else if (Player.currentWeapon.type == 2) {
        if (Player.currentWeapon.fireDamage > 0 && Player.currentWeapon.iceDamage == 0 && Player.currentWeapon.poisonDamage == 0) {
            $("#sidebar").append("<h3 style='margin-bottom: 0px;'>Weapon Stats:</h3><br><div id='weaponContainer'><img class='weapon fire lvl" + Player.currentWeapon.weaponLevel + "' src='icons/axe_shard.png' width='10px' height='10px'><div id='wStatContainer'>Name: " + Player.currentWeapon.name + "<br>Type: " + Player.currentWeapon.type + "<br>Damage: " + Player.currentWeapon.baseDamage + "<br>Range: " + Player.currentWeapon.range + "<br>Elemental Damage:<br>Attributes: </div></div></div>");
        } else if (Player.currentWeapon.iceDamage > 0 && Player.currentWeapon.fireDamage == 0 && Player.currentWeapon.poisonDamage == 0) {
            $("#sidebar").append("<h3 style='margin-bottom: 0px;'>Weapon Stats:</h3><br><div id='weaponContainer'><img class='weapon ice lvl" + Player.currentWeapon.weaponLevel + "' src='icons/axe_shard.png' width='10px' height='10px'><div id='wStatContainer'>Name: " + Player.currentWeapon.name + "<br>Type: " + Player.currentWeapon.type + "<br>Damage: " + Player.currentWeapon.baseDamage + "<br>Range: " + Player.currentWeapon.range + "<br>Elemental Damage:<br>Attributes: </div></div></div>");
        } else if (Player.currentWeapon.poisonDamage > 0 && Player.currentWeapon.iceDamage == 0 && Player.currentWeapon.fireDamage == 0) {
            $("#sidebar").append("<h3 style='margin-bottom: 0px;'>Weapon Stats:</h3><br><div id='weaponContainer'><img class='weapon poison lvl" + Player.currentWeapon.weaponLevel + "' src='icons/axe_shard.png' width='10px' height='10px'><div id='wStatContainer'>Name: " + Player.currentWeapon.name + "<br>Type: " + Player.currentWeapon.type + "<br>Damage: " + Player.currentWeapon.baseDamage + "<br>Range: " + Player.currentWeapon.range + "<br>Elemental Damage:<br>Attributes: </div></div></div>");
        } else {
            $("#sidebar").append("<h3 style='margin-bottom: 0px;'>Weapon Stats:</h3><br><div id='weaponContainer'><img class='weapon lvl" + Player.currentWeapon.weaponLevel + "' src='icons/axe_shard.png' width='10px' height='10px'><div id='wStatContainer'>Name: " + Player.currentWeapon.name + "<br>Type: " + Player.currentWeapon.type + "<br>Damage: " + Player.currentWeapon.baseDamage + "<br>Range: " + Player.currentWeapon.range + "<br>Elemental Damage:<br>Attributes: </div></div></div>");
        }
    } else if (Player.currentWeapon.type == 3) {
        if (Player.currentWeapon.fireDamage > 0 && Player.currentWeapon.iceDamage == 0 && Player.currentWeapon.poisonDamage == 0) {
            $("#sidebar").append("<h3 style='margin-bottom: 0px;'>Weapon Stats:</h3><br><div id='weaponContainer'><img class='weapon fire lvl" + Player.currentWeapon.weaponLevel + "' src='icons/bow_shard.png' width='10px' height='10px'><div id='wStatContainer'>Name: " + Player.currentWeapon.name + "<br>Type: " + Player.currentWeapon.type + "<br>Damage: " + Player.currentWeapon.baseDamage + "<br>Range: " + Player.currentWeapon.range + "<br>Elemental Damage:<br>Attributes: </div></div></div>");
        } else if (Player.currentWeapon.iceDamage > 0 && Player.currentWeapon.fireDamage == 0 && Player.currentWeapon.poisonDamage == 0) {
            $("#sidebar").append("<h3 style='margin-bottom: 0px;'>Weapon Stats:</h3><br><div id='weaponContainer'><img class='weapon ice lvl" + Player.currentWeapon.weaponLevel + "' src='icons/bow_shard.png' width='10px' height='10px'><div id='wStatContainer'>Name: " + Player.currentWeapon.name + "<br>Type: " + Player.currentWeapon.type + "<br>Damage: " + Player.currentWeapon.baseDamage + "<br>Range: " + Player.currentWeapon.range + "<br>Elemental Damage:<br>Attributes: </div></div></div>");
        } else if (Player.currentWeapon.poisonDamage > 0 && Player.currentWeapon.iceDamage == 0 && Player.currentWeapon.fireDamage == 0) {
            $("#sidebar").append("<h3 style='margin-bottom: 0px;'>Weapon Stats:</h3><br><div id='weaponContainer'><img class='weapon poison lvl" + Player.currentWeapon.weaponLevel + "' src='icons/bow_shard.png' width='10px' height='10px'><div id='wStatContainer'>Name: " + Player.currentWeapon.name + "<br>Type: " + Player.currentWeapon.type + "<br>Damage: " + Player.currentWeapon.baseDamage + "<br>Range: " + Player.currentWeapon.range + "<br>Elemental Damage:<br>Attributes: </div></div></div>");
        } else {
            $("#sidebar").append("<h3 style='margin-bottom: 0px;'>Weapon Stats:</h3><br><div id='weaponContainer'><img class='weapon lvl" + Player.currentWeapon.weaponLevel + "' src='icons/bow_shard.png' width='10px' height='10px'><div id='wStatContainer'>Name: " + Player.currentWeapon.name + "<br>Type: " + Player.currentWeapon.type + "<br>Damage: " + Player.currentWeapon.baseDamage + "<br>Range: " + Player.currentWeapon.range + "<br>Elemental Damage:<br>Attributes: </div></div></div>");
        }
    }
...
function Battle() {
    battle++;
    $("#inventoryOpt").hide();
    // console.log(battle); For Debugging

    var randomPrefix = Math.floor(Math.random() * enemyNamePrefix.length);
    var randomSuffix = Math.floor(Math.random() * enemyNameSuffix.length);

    // Enemy Creation
    if (battle >= 1 && battle <= 10) {
        enemyLevel = 1;
        enemyName = enemyNamePrefix[randomPrefix] + " " + enemyNameSuffix[randomSuffix];
                ...
                if (Player.currentWeapon.range > enemyDistance) {
                    if (Player.currentWeapon.range >= 8 && enemyRange >= enemyDistance) {
                        ...
                        if (enemyRange >= (enemyDistance + 3) && enemyRange > 7) {
                            ...
                            distanceGuess += 3;
                            output.append("<br>The distance guess is now: " + distanceGuess);
                        } else if (enemyRange >= (enemyDistance + 2) && enemyRange > 6) {
                            output.append("<br>The enemy moves 2 spaces away");
                            enemyDistance += 2;
                            distanceGuess += 2;
                            output.append("<br>The distance guess is now: " + distanceGuess);
...
function inventoryPage() {
    ...
    for (var hCrystal = 0; hCrystal < Player.inventory[3][1][1][0].length; hCrystal++) {
        ...
        $("#tr" + rowNumber.toString()).append("<td><div class='select unselected healthcrystal lvl" + Player.inventory[3][1][1][1][hCrystal].toString() + "' id='" + "slot" + rowNumber.toString() + slotID.toString() + "'> <img src='icons/healthcrystal.png'>" + Player.inventory[3][1][1][0][hCrystal] + "<span class='info'>" + hCrystal + "</span></div></td>");
    }
    ...
    for (var weaponSel = 0; weaponSel < Player.weaponInventory.length; weaponSel++) {
        ...
        if (Player.weaponInventory[weaponSel].type == 1) {
            ...
            if (Player.weaponInventory[weaponSel].fireDamage > 0 && Player.weaponInventory[weaponSel].iceDamage == 0 && Player.weaponInventory[weaponSel].poisonDamage == 0) {
                $("#tr" + rowNumber.toString()).append("<td><div class='select unselected weapon fire type" + Player.weaponInventory[weaponSel].type + " lvl" + Player.weaponInventory[weaponSel].weaponLevel + "' id='" + "slot" + rowNumber.toString() + slotID.toString() + "'> <img src='icons/axe_shard.png'>" + Player.weaponInventory[weaponSel].name + "<span class='info'>" + weaponSel + "</span></div></td>");
            } else if (Player.weaponInventory[weaponSel].iceDamage > 0 && Player.weaponInventory[weaponSel].fireDamage == 0 && Player.weaponInventory[weaponSel].poisonDamage == 0) {
                $("#tr" + rowNumber.toString()).append("<td><div class='select unselected weapon ice type" + Player.weaponInventory[weaponSel].type + " lvl" + Player.weaponInventory[weaponSel].weaponLevel + "' id='" + "slot" + rowNumber.toString() + slotID.toString() + "'> <img src='icons/axe_shard.png'>" + Player.weaponInventory[weaponSel].name + "<span class='info'>" + weaponSel + "</span></div></td>");
            } else if (Player.weaponInventory[weaponSel].poisonDamage > 0 && Player.weaponInventory[weaponSel].iceDamage == 0 && Player.weaponInventory[weaponSel].fireDamage == 0) {
                $("#tr" + rowNumber.toString()).append("<td><div class='select unselected weapon poison type" + Player.weaponInventory[weaponSel].type + " lvl" + Player.weaponInventory[weaponSel].weaponLevel + "' id='" + "slot" + rowNumber.toString() + slotID.toString() + "'> <img src='icons/axe_shard.png'>" + Player.weaponInventory[weaponSel].name + "<span class='info'>" + weaponSel + "</span></div></td>");
            ...
            if (Player.weaponInventory[weaponSel].fireDamage > 0 && Player.weaponInventory[weaponSel].iceDamage == 0 && Player.weaponInventory[weaponSel].poisonDamage == 0) {
                $("#tr" + rowNumber.toString()).append("<td><div class='select unselected weapon fire type" + Player.weaponInventory[weaponSel].type + " lvl" + Player.weaponInventory[weaponSel].weaponLevel + "' id='" + "slot" + rowNumber.toString() + slotID.toString() + "'> <img src='icons/bow_shard.png'>" + Player.weaponInventory[weaponSel].name + "<span class='info'>" + weaponSel + "</span></div></td>");
            } else if (Player.weaponInventory[weaponSel].iceDamage > 0 && Player.weaponInventory[weaponSel].fireDamage == 0 && Player.weaponInventory[weaponSel].poisonDamage == 0) {
                $("#tr" + rowNumber.toString()).append("<td><div class='select unselected weapon ice type" + Player.weaponInventory[weaponSel].type + " lvl" + Player.weaponInventory[weaponSel].weaponLevel + "' id='" + "slot" + rowNumber.toString() + slotID.toString() + "'> <img src='icons/bow_shard.png'>" + Player.weaponInventory[weaponSel].name + "<span class='info'>" + weaponSel + "</span></div></td>");
            } else if (Player.weaponInventory[weaponSel].poisonDamage > 0 && Player.weaponInventory[weaponSel].iceDamage == 0 && Player.weaponInventory[weaponSel].fireDamage == 0) {
                $("#tr" + rowNumber.toString()).append("<td><div class='select unselected weapon poison type" + Player.weaponInventory[weaponSel].type + " lvl" + Player.weaponInventory[weaponSel].weaponLevel + "' id='" + "slot" + rowNumber.toString() + slotID.toString() + "'> <img src='icons/bow_shard.png'>" + Player.weaponInventory[weaponSel].name + "<span class='info'>" + weaponSel + "</span></div></td>");
    ...
    $("#inventoryBTN").click(function() {
	 ...
	 $("#skillTree").click(function() {
		 $(document).off("keydown");
		 $("#nextBattle").remove();
       $("#inventoryOpt").html("<h1>Skill Tree:</h1><br><br><center><div id='skpDiv'>Skill Points: " + Player.skillPoints + "</div><br><table id='skillTable'><tbody><tr id='skillHead'><td>Combat</td><td>Tactics</td><td>Player</td></tr><tr class='srow'><td class='tree'>Placeholder 0/1</td><td class='tree'>Placeholder 0/1</td><td id='skillInvSlot' class='tree'>Inventory Slots " + Player.inventoryEquipped.length + "/10</td></tr><tr class='srowOfset'><td class='tree'>Placeholder 0/1</td><td class='tree'>Placeholder 0/1</td><td class='tree'>Placeholder 0/1</td></tr><tr class='srow'><td class='tree'>Placeholder 0/1</td><td class='tree'>Placeholder 0/1</td><td class='tree'>Placeholder 0/1</td></tr><tr class='srowOfset'><td class='tree'>Placeholder 0/1</td><td class='tree'>Placeholder 0/1</td><td class='tree'>Placeholder 0/1</td></tr><tr class='srow'><td class='tree'>Placeholder 0/1</td><td class='tree'>Placeholder 0/1</td><td class='tree'>Placeholder 0/1</td></tr><tr class='srowOfset'><td class='tree'>Placeholder 0/1</td><td class='tree'>Placeholder 0/1</td><td class='tree'>Placeholder 0/1</td></tr></tbody></table></center>");
    ...
    for (var invslots = 0; invslots < Player.inventoryEquipped.length; invslots++) {
        ...
        if (Player.inventoryEquipped[(slotID - 1)].length > 1) {
            if (Player.inventoryEquipped[(slotID - 1)][1] == "energycrystal") {
                $("#tr" + rowNumber.toString()).append("<td><div class='select unselected invslot energycrystal lvl1 filled' id='" + "slot" + slotID.toString() + "'><img src='icons/energycrystal.png'>Small Energy Crystal</div></td>");
            } else if (Player.inventoryEquipped[(slotID - 1)][1] == "energycrystal2") {
                $("#tr" + rowNumber.toString()).append("<td><div class='select unselected invslot energycrystal lvl2 filled' id='" + "slot" + slotID.toString() + "'><img src='icons/energycrystal.png'>Average Energy Crystal</div></td>");
            } else if (Player.inventoryEquipped[(slotID - 1)][1] == "healthcrystal") {
                $("#tr" + rowNumber.toString()).append("<td><div class='select unselected invslot healthcrystal lvl1 filled' id='" + "slot" + slotID.toString() + "'><img src='icons/healthcrystal.png'>Small Health Crystal</div></td>");
            } else if (Player.inventoryEquipped[(slotID - 1)][1].toString() == "healthcrystal2") {
                $("#tr" + rowNumber.toString()).append("<td><div class='select unselected invslot healthcrystal lvl2 filled' id='" + "slot" + slotID.toString() + "'><img src='icons/healthcrystal.png'>Average Health Crystal</div></td>");
            }
        } else {
    ...
    for (var invslots = 0; invslots < Player.inventoryEquipped.length; invslots++) {
        ...
        if (Player.inventoryEquipped[(slotID - 1)].length > 1) {
            if (Player.inventoryEquipped[(slotID - 1)][1] == "energycrystal") {
                ...
                $("#tr" + rowNumber.toString()).append("<td><div class='select unselected invslot healthcrystal lvl1 flilled' id='" + "slot" + slotID.toString() + "'><img src='icons/healthcrystal.png'>Small Health Crystal</div></td>");
            } else if (Player.inventoryEquipped[(slotID - 1)][1].toString() == "healthcrystal2") {
                $("#tr" + rowNumber.toString()).append("<td><div class='select unselected invslot healthcrystal lvl2 filled' id='" + "slot" + slotID.toString() + "'><img src='icons/healthcrystal.png'>Average Health Crystal</div></td>");
            }
        } else {
